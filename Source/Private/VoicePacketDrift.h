...
class FVoicePacketDrift : public FVoicePacket
{
...
public:
	 ...
	 */
	FVoicePacketDrift(const FVoicePacketDrift& Other);
...
struct FVoiceDataDrift
{
	/** Data used by the local talkers before sent */
	FVoicePacketDrift LocalPackets[MAX_SPLITSCREEN_TALKERS];
