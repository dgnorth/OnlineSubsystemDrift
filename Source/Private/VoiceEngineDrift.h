 ...
 */
class FRemoteTalkerDataDrift
{
public:

	FRemoteTalkerDataDrift();
	~FRemoteTalkerDataDrift();
...
class FVoiceEngineDrift : public IVoiceEngine
{
	...
	public:
		...
		FVoiceSerializeHelper(FVoiceEngineDrift* InVoiceEngine) :
...
public:
	...
	FVoiceEngineDrift(IOnlineSubsystem* InSubsystem);
	virtual ~FVoiceEngineDrift();
...
typedef TSharedPtr<FVoiceEngineDrift, ESPMode::ThreadSafe> FVoiceEngineDriftPtr;
