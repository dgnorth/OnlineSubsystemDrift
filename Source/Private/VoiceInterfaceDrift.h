...
class ONLINESUBSYSTEMDRIFT_API FOnlineVoiceDrift : public IOnlineVoice
{
...
public:
	...
	/** Constructor */
	FOnlineVoiceDrift(class IOnlineSubsystem* InOnlineSubsystem);

	/** Virtual destructor to force proper child cleanup */
	virtual ~FOnlineVoiceDrift();
...
typedef TSharedPtr<FOnlineVoiceDrift, ESPMode::ThreadSafe> FOnlineVoiceDriftPtr;
