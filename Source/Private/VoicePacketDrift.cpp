 ...
 */
FVoicePacketDrift::FVoicePacketDrift(const FVoicePacketDrift& Other) :
	FVoicePacket(Other)
{
	Sender = Other.Sender;
	Length = Other.Length;
...
uint16 FVoicePacketDrift::GetTotalPacketSize()
{
...
uint16 FVoicePacketDrift::GetBufferSize()
{
	return Length;
}

/** @return the sender of this voice packet */
TSharedPtr<const FUniqueNetId> FVoicePacketDrift::GetSender()
{
	return Sender;
}
 ...
 */
void FVoicePacketDrift::Serialize(class FArchive& Ar)
{
